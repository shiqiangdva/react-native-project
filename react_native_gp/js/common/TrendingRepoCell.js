...
export default class TrendingRepoCell extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            favoriteIcon: this.props.projectModel.isFavorite ? require('../../res/image/ic_star.png') : require('../../res/image/ic_unstar_transparent.png'),
        };
    }
    ...
    setFavoriteState(isFavorite) {
        ...
        this.setState({
            ...
            favoriteIcon: isFavorite ? require('../../res/image/ic_star.png') : require('../../res/image/ic_unstar_transparent.png')
        })
    }
